 ...
 */
public class ServiceRunnerColumnPositionTest extends TestBase {
	
	AtomicInteger testCount = new AtomicInteger(0);

	@BeforeClass
	public void beforeClass()  {
		ConfigVariable.apiParallelTestcasePath().setValue("../apiTestData/testCases/frameworkTests/columnPosition/");
	...
	public void afterClass()  {	
		Helper.assertEquals(6, testCount.get());
	}	
}